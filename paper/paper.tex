...
The goal of this paper is to advance formal methods in elections by demonstrating how STV vote counting can be verified in a modular, transparent, and practical feasible way over a minimal computational trust base:  we show how to synthesise practically feasible and provably correct verifies for a large class of STV schemes in a modular and almost fully automated way. 
...
\bibitem{cake}
R. Kumar, M.O. Myreen, M. Norrish, S. Owens, CakeML: A Verified
  Implementation of ML, POPL, 2014
\bibitem{hol}
